...
class StateSpinnerAdapter(
    ...
    private val layoutInflater: LayoutInflater) : ArrayAdapter<String>(context, android.R.layout.simple_spinner_item, adapterList) {
    ...
    private fun getCustomView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        viewHolder.textView.text = adapterList[position]
